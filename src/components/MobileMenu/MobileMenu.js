        ...
        <div className="mobile-menu mobile-menu_inner">
          <div className="mobile-menu__header_inner">
            <a
              href="#Intro"
              crossOrigin="true"
              className="mobile-menu__logo_inner"
              onClick={(e) => {
                clickHandlerClose();
                clickHandleChangeActive("Intro");
              }}
            >
              <img
                src="/logo/logo.svg"
                alt="Svistel"
                className="mobile-menu__logo-img_inner"
              />
            </a>
                  ...
                  index !== navigation.length - 1 && (
                    ...
                    >
                      <a
                        ...
                        onClick={(e) => {
                          clickHandlerClose(e);
                          clickHandleChangeActive(item.title);
                        }}
                      >
          ...
          <div className="mobile-menu_cta">
            <p>Contact Us</p>
            <a href="mailto:info@svistel.in">info@svistel.in</a>
          </div>
        </div>
      ) : null}
    </div>
